    ...
    try {
      ...
      canvas.toBlob((blob) => {
        if (blob) {
          ...
          link.href = url;
          link.download = `暖伴对话_${getCurrentTime()}.png`;
          link.click();
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
        <div className="w-full max-w-md max-h-[85vh] flex flex-col bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            >
              {/* 头部：标题和时间 */}
              <div style={{ borderBottom: '1px solid rgb(254, 215, 170)', paddingBottom: '16px' }}>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm" style={{ color: 'rgb(107, 114, 128)' }}>{getCurrentTime()}</p>
                  </div>
                </div>
              </div>
                    ...
                    {msg.type === "user" ? (
                      <div className="flex justify-end">
                        <div 
                          ...
                          style={{ background: 'linear-gradient(to bottom right, rgb(96, 165, 250), rgb(59, 130, 246))' }}
                        >
                      ...
                      <div className="flex justify-start">
                        ...
                        >
                          <p className="text-base leading-relaxed" style={{ color: 'rgb(31, 41, 55)' }}>
                            {msg.content}
                          </p>
                        </div>
                      </div>
              ...
              {/* 底部：品牌信息 */}
              <div style={{ borderTop: '1px solid rgb(254, 215, 170)', paddingTop: '16px' }}>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-base font-semibold" style={{ color: 'rgb(251, 146, 60)' }}>
                      暖伴
                    </p>
