...
interface MemberUpsellModalProps {
  giftName: string;
  onConfirm: () => void;
  onClose: () => void;
}

export function MemberUpsellModal({ giftName, onConfirm, onClose }: MemberUpsellModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      <div className="relative glass-card rounded-3xl p-8 max-w-md w-full space-y-6">
        ...
        <button
          ...
          className="w-full py-5 rounded-2xl bg-gradient-to-r from-primary to-secondary text-white font-bold text-xl disabled:opacity-50 disabled:cursor-not-allowed shadow-xl hover:shadow-2xl transition-all hover:scale-105"
        >
        ...
        <div className="text-center -mt-2">
          <p className="text-[9px] text-muted-foreground/40 leading-tight opacity-60">
